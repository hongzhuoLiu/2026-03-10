        ...
        <div className="container mx-auto px-4 py-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-center mb-6">
                    <img 
                        src={review.attributes.users_permissions_user?.data?.attributes?.avatar?.data?.attributes?.url 
                            ? `${BASE_URL}${review.attributes.users_permissions_user.data.attributes.avatar.data.attributes.url}`
                    ...
                    <div>
                        <h2 className="text-xl font-semibold">
                            {review.attributes.users_permissions_user?.data?.attributes?.username || 'Anonymous'}
                        </h2>
                ...
                <div className="mt-6 flex items-center gap-4">
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-600">
                            {review.attributes.reviewLikes || 0}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <span className="text-gray-600">
                            {review.attributes.comments?.data?.length || 0}
                        </span>
                    </div>
                </div>

                {review.attributes.comments?.data && review.attributes.comments.data.length > 0 && (
                    <div className="mt-8">
                        <h3 className="text-xl font-semibold mb-4">Comments</h3>
                        <div className="space-y-4">
                            {review.attributes.comments.data.map(comment => (
